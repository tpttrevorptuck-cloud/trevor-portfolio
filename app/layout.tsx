...
export const metadata: Metadata = {
  ...
  description:
    "Mission-driven communications, storytelling, and digital strategy — case studies, writing, and impact briefs.",
};
        ...
        <header className="border-b border-slate-200">
          <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
            ...
            <nav className="flex gap-4 text-sm font-medium text-slate-200">
              <a className="hover:text-slate-700" href="/work">Work</a>
              <a className="hover:text-slate-700" href="/resume">Resume</a>
